...
def train(input_batches, input_lengths, target_batches, target_lengths, 
    ...
    #print(TT(input_topic, decoder_hidden).detach())
    topic_target_hat = TT(input_topic, decoder_hidden).detach()
    ...
    for t in range(max_target_length):
        decoder_output, decoder_hidden, decoder_attn = decoder(decoder_input, decoder_hidden, topic_target_hat, encoder_outputs)
...
def train_mlp(input_batches, input_lengths, input_topic, target_topic, 
    ...
    if topic_choice == 'NTM':
        loss = ntm_topic_loss(input_topic, target_topic, encoder_hidden, TT, batch_size, TT_optimizer)
    sys.stdout.flush()
