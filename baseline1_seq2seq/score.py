...
from Bleu import score_sentence
...
def score_calculator(y_hat, y_true):
    ...
    # generated:[batch_size,document_length]
    # reference:[batch_size,document_length]
    
    bleu_scores =[0,0,0,0]
    for i in range(1,5):
        bleu_scores[i-1] = score_corpus(generated, reference, ngrams=i, smooth=1e-8)
        #bleu_scores[i-1] = score_sentence(generated, reference, ngrams=i, smooth=1e-8)
