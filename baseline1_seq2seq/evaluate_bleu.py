...
def evaluate_and_show_attention(val_input, val_input_lengs, val_target, val_target_lengs, batch_size, encoder, decoder, input_voc, output_voc):
    ...
    output_words, decoded_words_one_EOS, attentions = evaluate(val_input, val_input_lengs, val_target, val_target_lengs, batch_size, encoder, decoder, input_voc, output_voc)
...
def evaluate_randomly_bleu(val_input, val_input_lengs, val_target, val_target_lengs, batch_size, encoder, decoder, input_voc, output_voc, target = True):
    if target == True:
