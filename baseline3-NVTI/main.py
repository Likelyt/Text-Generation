...
parser.add_argument("-end_epoch", type=int, default=30, help="Epoch to stop training.")
...
parser.add_argument("-n_topic", type=int, default=10, help="Number of topic number: J")
...
parser.add_argument("-h2_testing_samples", type=int, default=1, help="Number of h2 samples in training")


## Random seed
parser.add_argument("-torch_seed", type=int, default=12345, help="Random seed for pytorch")
parser.add_argument("-sampling_seed", type=int, default=12345, help="Random seed for sampling")
...
if __name__ == "__main__":
    ...
    np.random.seed(opt.sampling_seed)
    '''
    ...
    vae_model_hidden_size = opt.hidden_size
